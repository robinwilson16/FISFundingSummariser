...
Once you have everything set up you can execute the following command to import a FIS ILR database:
	...
	EXEC SPR_Run_FIS_FundingData 'ILR2526', '25/26', 'R03', 1, 'I'
