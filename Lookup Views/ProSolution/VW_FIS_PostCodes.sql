CREATE OR ALTER VIEW VW_FIS_PostCodes
AS
	SELECT
	...
	FROM [dbs-mis-02\advanced].ProGeneral.dbo.PostCodeWard PCW
	LEFT JOIN [dbs-mis-02\advanced].ProGeneral.dbo.PostCodeUplift PCU
