/*
Changes since 23/24
Funding Model 38 Added
Destination and Progression Fields Removed

*/

CREATE OR ALTER PROCEDURE dbo.SPR_FIS_FundingData_2425
...
BEGIN
	...
	DECLARE @FISDatabase NVARCHAR(100) = 'ILR2425' 
	...
	DECLARE @FISOutputTableLocation NVARCHAR(200) = 'InformationServices.dbo.' 
	...
	*/
	...
	SET @SQLString = 
		...
		DROP TABLE IF EXISTS #FM25RateBands;
		SELECT
			RB.RateBand,
			RB.NationalFundingRate
		INTO #FM25RateBands
		FROM FIS_1619RateBands RB
		WHERE
	...
	SET @SQLString += 
		...
		SELECT
				...
				ProviderPaymentToPeriod = SUM ( CASE WHEN FM38P.Period <= TRY_CAST ( REPLACE ( @ILRReturn, ''R'', '''' ) AS INT ) THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
				...
				ProviderPaymentMidYear = SUM ( CASE WHEN FM38P.Period BETWEEN 1 AND 6 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
				...
				ProviderPaymentYearEnd = SUM ( FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ),
    ...
    SET @SQLString += 
        N'
				...
				ProviderPaymentP01 = SUM ( CASE WHEN FM38P.Period = 1 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
				...
				ProviderPaymentP02 = SUM ( CASE WHEN FM38P.Period = 2 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
    ...
    SET @SQLString += 
        N'
				...
				ProviderPaymentP03 = SUM ( CASE WHEN FM38P.Period = 3 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
				...
				ProviderPaymentP04 = SUM ( CASE WHEN FM38P.Period = 4 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
    ...
    SET @SQLString += 
        N'
				...
				ProviderPaymentP05 = SUM ( CASE WHEN FM38P.Period = 5 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
				...
				ProviderPaymentP06 = SUM ( CASE WHEN FM38P.Period = 6 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
    ...
    SET @SQLString += 
        N'
				...
				ProviderPaymentP07 = SUM ( CASE WHEN FM38P.Period = 7 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
				...
				ProviderPaymentP08 = SUM ( CASE WHEN FM38P.Period = 8 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
    ...
    SET @SQLString += 
        N'
				...
				ProviderPaymentP09 = SUM ( CASE WHEN FM38P.Period = 9 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
				...
				ProviderPaymentP10 = SUM ( CASE WHEN FM38P.Period = 10 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
    ...
    SET @SQLString += 
        N'
				...
				ProviderPaymentP11 = SUM ( CASE WHEN FM38P.Period = 11 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
				...
				ProviderPaymentP12 = SUM ( CASE WHEN FM38P.Period = 12 THEN FM38P.OnProgPayment + FM38P.BalancePayment + FM38P.CompletionPayment + FM38P.AchievePayment + FM38P.EmpOutcomePay ELSE 0 END ),
	...
	SET @SQLString += 
        N'
			...
			SELECT
				...
				LearnDelFirstProv1618PayToPeriod = 
					SUM ( CASE WHEN FM36P.Period <= TRY_CAST ( REPLACE ( @ILRReturn, ''R'', '''' ) AS INT ) THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayToPeriod = 
					SUM ( CASE WHEN FM36P.Period <= TRY_CAST ( REPLACE ( @ILRReturn, ''R'', '''' ) AS INT ) THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayToPeriod = 
					SUM ( CASE WHEN FM36P.Period <= TRY_CAST ( REPLACE ( @ILRReturn, ''R'', '''' ) AS INT ) THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayToPeriod = 
					SUM ( CASE WHEN FM36P.Period <= TRY_CAST ( REPLACE ( @ILRReturn, ''R'', '''' ) AS INT ) THEN 
    ...
    SET @SQLString += 
		N'
				...
				LearnDelFirstProv1618PayMidYear = 
					SUM ( CASE WHEN FM36P.Period <= 6 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayMidYear = 
					SUM ( CASE WHEN FM36P.Period <= 6 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayMidYear = 
					SUM ( CASE WHEN FM36P.Period <= 6 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayMidYear = 
					SUM ( CASE WHEN FM36P.Period <= 6 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
	...
	SET @SQLString += 
        N'
				...
				LearnDelFirstProv1618PayYearEnd = 
					SUM ( 
						FM36P.LearnDelFirstProv1618Pay 
					),
				LearnDelSecondProv1618PayYearEnd = 
					SUM ( 
						FM36P.LearnDelSecondProv1618Pay 
					),
				LearnDelFirstEmp1618PayYearEnd = 
					SUM ( 
						FM36P.LearnDelFirstEmp1618Pay 
					),
				LearnDelSecondEmp1618PayYearEnd = 
					SUM ( 
						FM36P.LearnDelSecondEmp1618Pay 
					),
    ...
    SET @SQLString += 
		N'
				...
				LearnDelFirstProv1618PayP01 = 
					SUM ( CASE WHEN FM36P.Period = 1 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP01 = 
					SUM ( CASE WHEN FM36P.Period = 1 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP01 = 
					SUM ( CASE WHEN FM36P.Period = 1 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP01 = 
					SUM ( CASE WHEN FM36P.Period = 1 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
	...
	SET @SQLString += 
        N'
				...
				LearnDelFirstProv1618PayP02 = 
					SUM ( CASE WHEN FM36P.Period = 2 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP02 = 
					SUM ( CASE WHEN FM36P.Period = 2 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP02 = 
					SUM ( CASE WHEN FM36P.Period = 2 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP02 = 
					SUM ( CASE WHEN FM36P.Period = 2 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
    ...
    SET @SQLString += 
		N'
				...
				LearnDelFirstProv1618PayP03 = 
					SUM ( CASE WHEN FM36P.Period = 3 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP03 = 
					SUM ( CASE WHEN FM36P.Period = 3 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP03 = 
					SUM ( CASE WHEN FM36P.Period = 3 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP03 = 
					SUM ( CASE WHEN FM36P.Period = 3 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
	...
	SET @SQLString += 
        N'
				...
				LearnDelFirstProv1618PayP04 = 
					SUM ( CASE WHEN FM36P.Period = 4 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP04 = 
					SUM ( CASE WHEN FM36P.Period = 4 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP04 = 
					SUM ( CASE WHEN FM36P.Period = 4 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP04 = 
					SUM ( CASE WHEN FM36P.Period = 4 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
    ...
    SET @SQLString += 
		N'
				...
				LearnDelFirstProv1618PayP05 = 
					SUM ( CASE WHEN FM36P.Period = 5 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP05 = 
					SUM ( CASE WHEN FM36P.Period = 5 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP05 = 
					SUM ( CASE WHEN FM36P.Period = 5 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP05 = 
					SUM ( CASE WHEN FM36P.Period = 5 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
	...
	SET @SQLString += 
        N'
				...
				LearnDelFirstProv1618PayP06 = 
					SUM ( CASE WHEN FM36P.Period = 6 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP06 = 
					SUM ( CASE WHEN FM36P.Period = 6 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP06 = 
					SUM ( CASE WHEN FM36P.Period = 6 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP06 = 
					SUM ( CASE WHEN FM36P.Period = 6 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
    ...
    SET @SQLString += 
		N'
				...
				LearnDelFirstProv1618PayP07 = 
					SUM ( CASE WHEN FM36P.Period = 7 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP07 = 
					SUM ( CASE WHEN FM36P.Period = 7 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP07 = 
					SUM ( CASE WHEN FM36P.Period = 7 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP07 = 
					SUM ( CASE WHEN FM36P.Period = 7 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
	...
	SET @SQLString += 
        N'
				...
				LearnDelFirstProv1618PayP08 = 
					SUM ( CASE WHEN FM36P.Period = 8 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP08 = 
					SUM ( CASE WHEN FM36P.Period = 8 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP08 = 
					SUM ( CASE WHEN FM36P.Period = 8 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP08 = 
					SUM ( CASE WHEN FM36P.Period = 8 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
    ...
    SET @SQLString += 
		N'
				...
				LearnDelFirstProv1618PayP09 = 
					SUM ( CASE WHEN FM36P.Period = 9 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP09 = 
					SUM ( CASE WHEN FM36P.Period = 9 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP09 = 
					SUM ( CASE WHEN FM36P.Period = 9 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP09 = 
					SUM ( CASE WHEN FM36P.Period = 9 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
	...
	SET @SQLString += 
        N'
				...
				LearnDelFirstProv1618PayP10 = 
					SUM ( CASE WHEN FM36P.Period = 10 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP10 = 
					SUM ( CASE WHEN FM36P.Period = 10 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP10 = 
					SUM ( CASE WHEN FM36P.Period = 10 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP10 = 
					SUM ( CASE WHEN FM36P.Period = 10 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
    ...
    SET @SQLString += 
		N'
				...
				LearnDelFirstProv1618PayP11 = 
					SUM ( CASE WHEN FM36P.Period = 11 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP11 = 
					SUM ( CASE WHEN FM36P.Period = 11 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP11 = 
					SUM ( CASE WHEN FM36P.Period = 11 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP11 = 
					SUM ( CASE WHEN FM36P.Period = 11 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
	...
	SET @SQLString += 
        N'
				...
				LearnDelFirstProv1618PayP12 = 
					SUM ( CASE WHEN FM36P.Period = 12 THEN 
						FM36P.LearnDelFirstProv1618Pay 
						ELSE 0 END
					),
				LearnDelSecondProv1618PayP12 = 
					SUM ( CASE WHEN FM36P.Period = 12 THEN 
						FM36P.LearnDelSecondProv1618Pay 
						ELSE 0 END
					),
				LearnDelFirstEmp1618PayP12 = 
					SUM ( CASE WHEN FM36P.Period = 12 THEN 
						FM36P.LearnDelFirstEmp1618Pay 
						ELSE 0 END
					),
				LearnDelSecondEmp1618PayP12 = 
					SUM ( CASE WHEN FM36P.Period = 12 THEN 
						FM36P.LearnDelSecondEmp1618Pay 
						ELSE 0 END
					),
    ...
    SET @SQLString += 
        N'
			...
			RateBandNationalFundingRate = FM25RB.NationalFundingRate,
			RateBandFullTimeEquiv = FM25.FullTimeEquiv,
    ...
    SET @SQLString += 
        N'
			...
			SubjectSectorArea1Code = AIM.SSA1Code,
			SubjectSectorArea1Title = AIM.SSA1Name,
			SubjectSectorArea2Code = AIM.SSA2Code,
			SubjectSectorArea2Title = AIM.SSA2Name,
			CourseCode = COALESCE ( CS.CourseCode, ''-''),
			CourseInstance = COALESCE ( CS.CourseInstance, ''-''),
			CourseTitle = COALESCE ( CS.CourseTitle, ''-- Unknown --''),
    ...
    SET @SQLString += 
        N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) * TRY_CAST ( REPLACE ( @ILRReturn, ''R'', '''' ) AS INT ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeHEAdvLoanPossibleIncome = 1 THEN ALBP.TotalEarnedCashToPeriod END, FM38P.ProviderPaymentToPeriod, FM35P.ProviderPaymentToPeriod, FM36PM.ProviderPaymentToPeriod, FM36P.ProviderPaymentToPeriod, ( CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12 ) * TRY_CAST ( REPLACE ( @ILRReturn, ''R'', '''' ) AS INT ), 0 ),
			...
			LearnDelSecondProv1618PayToPeriod = COALESCE ( FM36PM.LearnDelSecondProv1618PayToPeriod, FM36P.LearnDelSecondProv1618PayToPeriod, 0 ),
			LearnDelFirstEmp1618PayToPeriod = COALESCE ( FM36PM.LearnDelFirstEmp1618PayToPeriod, FM36P.LearnDelFirstEmp1618PayToPeriod, 0 ),
			LearnDelSecondEmp1618PayToPeriod = COALESCE ( FM36PM.LearnDelSecondEmp1618PayToPeriod, FM36P.LearnDelSecondEmp1618PayToPeriod, 0 ),
    ...
    SET @SQLString += 
        N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) * 6 END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashMidYear END, FM38P.ProviderPaymentMidYear, FM35P.ProviderPaymentMidYear, FM36PM.ProviderPaymentMidYear, FM36P.ProviderPaymentMidYear, ( CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12 ) * 6, 0 ),
			...
			LearnDelSecondProv1618PayMidYear = COALESCE ( FM36PM.LearnDelSecondProv1618PayMidYear, FM36P.LearnDelSecondProv1618PayMidYear, 0 ),
			LearnDelFirstEmp1618PayMidYear = COALESCE ( FM36PM.LearnDelFirstEmp1618PayMidYear, FM36P.LearnDelFirstEmp1618PayMidYear, 0 ),
			LearnDelSecondEmp1618PayMidYear = COALESCE ( FM36PM.LearnDelSecondEmp1618PayMidYear, FM36P.LearnDelSecondEmp1618PayMidYear, 0 ),
    ...
    SET @SQLString += 
		N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashYearEnd END, FM38P.ProviderPaymentYearEnd, FM35P.ProviderPaymentYearEnd, FM36PM.ProviderPaymentYearEnd, FM36P.ProviderPaymentYearEnd, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END, 0 ),
			...
			LearnDelSecondProv1618PayYearEnd = COALESCE ( FM36PM.LearnDelSecondProv1618PayYearEnd, FM36P.LearnDelSecondProv1618PayYearEnd, 0 ),
			LearnDelFirstEmp1618PayYearEnd = COALESCE ( FM36PM.LearnDelFirstEmp1618PayYearEnd, FM36P.LearnDelFirstEmp1618PayYearEnd, 0 ),
			LearnDelSecondEmp1618PayYearEnd = COALESCE ( FM36PM.LearnDelSecondEmp1618PayYearEnd, FM36P.LearnDelSecondEmp1618PayYearEnd, 0 ),
    ...
    SET @SQLString += 
        N'
			...
			FutureAchievePayment = 
				CASE
					WHEN LD.LearnPlanEndDate > ''20'' + RIGHT ( @AcademicYear, 2 ) + ''-07-31'' THEN 0
					WHEN LD.CompStatus = 1 THEN COALESCE ( FM38.CompletionElement, 0 ) + COALESCE ( FM38.AchieveElement, 0 ) + COALESCE ( FM35.AchieveElement, 0 ) + COALESCE ( FM36PE.PriceEpisodeCompletionElement, 0 )
					WHEN LD.CompStatus = 2 AND LD.Outcome = 8 THEN COALESCE ( FM38.AchieveElement, 0 ) + COALESCE ( FM35.AchieveElement, 0 )
					ELSE 0
				END,
			...
			FutureAchievePaymentWeighted = 
				CASE
					...
					WHEN LD.CompStatus = 2 AND LD.Outcome = 8 THEN COALESCE ( FM38.AchieveElement, 0 ) + COALESCE ( FM35.AchieveElement, 0 )
					ELSE 0
				END * @FutureAchievementWeighting,
	'
	...
	SET @SQLString += 
        N'
			...
			Block1DisadvUpliftCash = 
				CASE
					WHEN COALESCE ( FM25.Block1DisadvUpliftNew, 0 ) > 0 THEN
						CASE
							WHEN FM25.RateBand LIKE ''%Band 1%'' THEN 
								( FM25RB.NationalFundingRate * FM25.FullTimeEquiv ) * ( COALESCE ( FM25.Block1DisadvUpliftNew, 0 ) - 1 )
							ELSE 
								FM25RB.NationalFundingRate * ( COALESCE ( FM25.Block1DisadvUpliftNew, 0 ) - 1 )
						END
					ELSE 0
				END,
			Block2DisadvUpliftRate = 
				CASE
					WHEN FM25.StartFund = 0 THEN 0
	...
	SET @SQLString += 
		...
		LEFT JOIN #FM38PeriodFunding FM38PM
			...
			AND FM38PM.FworkCode = COALESCE ( LD.FworkCode, 0 )
			AND FM38PM.ProgType = LD.ProgType
			AND FM38PM.PwayCode = COALESCE ( LD.PwayCode, 0 )
			AND 
				CASE
					WHEN LD.CompStatus = 6 THEN
						CASE
    ...
    SET @SQLString += 
		...
		LEFT JOIN (
			...
			ON 1 = 1
		LEFT JOIN #FM25RateBands FM25RB
			ON FM25RB.RateBand = 
				CASE
					WHEN 
						CHARINDEX ( ''Band '', FM25.RateBand ) > 0 
    ...
    SET @SQLString += 
		N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP01 END, FM38P.ProviderPaymentP01, FM35P.ProviderPaymentP01, FM36PM.ProviderPaymentP01, FM36P.ProviderPaymentP01, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP01 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP01, FM36P.LearnDelSecondProv1618PayP01, 0 ),
			LearnDelFirstEmp1618PayP01 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP01, FM36P.LearnDelFirstEmp1618PayP01, 0 ),
			LearnDelSecondEmp1618PayP01 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP01, FM36P.LearnDelSecondEmp1618PayP01, 0 ),
    ...
    SET @SQLString += 
        N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP02 END, FM38P.ProviderPaymentP02, FM35P.ProviderPaymentP02, FM36PM.ProviderPaymentP02, FM36P.ProviderPaymentP02, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP02 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP02, FM36P.LearnDelSecondProv1618PayP02, 0 ),
			LearnDelFirstEmp1618PayP02 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP02, FM36P.LearnDelFirstEmp1618PayP02, 0 ),
			LearnDelSecondEmp1618PayP02 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP02, FM36P.LearnDelSecondEmp1618PayP02, 0 ),
    ...
    SET @SQLString += 
		N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP03 END, FM38P.ProviderPaymentP03, FM35P.ProviderPaymentP03, FM36PM.ProviderPaymentP03, FM36P.ProviderPaymentP03, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP03 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP03, FM36P.LearnDelSecondProv1618PayP03, 0 ),
			LearnDelFirstEmp1618PayP03 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP03, FM36P.LearnDelFirstEmp1618PayP03, 0 ),
			LearnDelSecondEmp1618PayP03 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP03, FM36P.LearnDelSecondEmp1618PayP03, 0 ),
    ...
    SET @SQLString += 
        N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP04 END, FM38P.ProviderPaymentP04, FM35P.ProviderPaymentP04, FM36PM.ProviderPaymentP04, FM36P.ProviderPaymentP04, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP04 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP04, FM36P.LearnDelSecondProv1618PayP04, 0 ),
			LearnDelFirstEmp1618PayP04 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP04, FM36P.LearnDelFirstEmp1618PayP04, 0 ),
			LearnDelSecondEmp1618PayP04 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP04, FM36P.LearnDelSecondEmp1618PayP04, 0 ),
    ...
    SET @SQLString += 
		N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP05 END, FM38P.ProviderPaymentP05, FM35P.ProviderPaymentP05, FM36PM.ProviderPaymentP05, FM36P.ProviderPaymentP05, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP05 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP05, FM36P.LearnDelSecondProv1618PayP05, 0 ),
			LearnDelFirstEmp1618PayP05 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP05, FM36P.LearnDelFirstEmp1618PayP05, 0 ),
			LearnDelSecondEmp1618PayP05 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP05, FM36P.LearnDelSecondEmp1618PayP05, 0 ),
    ...
    SET @SQLString += 
        N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP06 END, FM38P.ProviderPaymentP06, FM35P.ProviderPaymentP06, FM36PM.ProviderPaymentP06, FM36P.ProviderPaymentP06, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP06 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP06, FM36P.LearnDelSecondProv1618PayP06, 0 ),
			LearnDelFirstEmp1618PayP06 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP06, FM36P.LearnDelFirstEmp1618PayP06, 0 ),
			LearnDelSecondEmp1618PayP06 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP06, FM36P.LearnDelSecondEmp1618PayP06, 0 ),
    ...
    SET @SQLString += 
		N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP07 END, FM38P.ProviderPaymentP07, FM35P.ProviderPaymentP07, FM36PM.ProviderPaymentP07, FM36P.ProviderPaymentP07, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP07 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP07, FM36P.LearnDelSecondProv1618PayP07, 0 ),
			LearnDelFirstEmp1618PayP07 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP07, FM36P.LearnDelFirstEmp1618PayP07, 0 ),
			LearnDelSecondEmp1618PayP07 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP07, FM36P.LearnDelSecondEmp1618PayP07, 0 ),
    ...
    SET @SQLString += 
        N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP08 END, FM38P.ProviderPaymentP08, FM35P.ProviderPaymentP08, FM36PM.ProviderPaymentP08, FM36P.ProviderPaymentP08, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP08 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP08, FM36P.LearnDelSecondProv1618PayP08, 0 ),
			LearnDelFirstEmp1618PayP08 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP08, FM36P.LearnDelFirstEmp1618PayP08, 0 ),
			LearnDelSecondEmp1618PayP08 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP08, FM36P.LearnDelSecondEmp1618PayP08, 0 ),
    ...
    SET @SQLString += 
		N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP09 END, FM38P.ProviderPaymentP09, FM35P.ProviderPaymentP09, FM36PM.ProviderPaymentP09, FM36P.ProviderPaymentP09, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP09 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP09, FM36P.LearnDelSecondProv1618PayP09, 0 ),
			LearnDelFirstEmp1618PayP09 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP09, FM36P.LearnDelFirstEmp1618PayP09, 0 ),
			LearnDelSecondEmp1618PayP09 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP09, FM36P.LearnDelSecondEmp1618PayP09, 0 ),
    ...
    SET @SQLString += 
        N'
				...
				ELSE
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP10 END, FM38P.ProviderPaymentP10, FM35P.ProviderPaymentP10, FM36PM.ProviderPaymentP10, FM36P.ProviderPaymentP10, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP10 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP10, FM36P.LearnDelSecondProv1618PayP10, 0 ),
			LearnDelFirstEmp1618PayP10 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP10, FM36P.LearnDelFirstEmp1618PayP10, 0 ),
			LearnDelSecondEmp1618PayP10 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP10, FM36P.LearnDelSecondEmp1618PayP10, 0 ),
    ...
    SET @SQLString += 
		N'
				...
				ELSE
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP11 END, FM38P.ProviderPaymentP11, FM35P.ProviderPaymentP11, FM36PM.ProviderPaymentP11, FM36P.ProviderPaymentP11, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP11 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP11, FM36P.LearnDelSecondProv1618PayP11, 0 ),
			LearnDelFirstEmp1618PayP11 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP11, FM36P.LearnDelFirstEmp1618PayP11, 0 ),
			LearnDelSecondEmp1618PayP11 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP11, FM36P.LearnDelSecondEmp1618PayP11, 0 ),
    ...
    SET @SQLString += 
        N'
				...
				ELSE 
					...
					- CASE 
						...
						ELSE
							0
					END
				END / 12 ) END, CASE WHEN ALB.AdvLoan = 1 AND @IncludeAdvLoanBursaryIncome = 1 THEN ALBP.TotalEarnedCashP12 END, FM38P.ProviderPaymentP12, FM35P.ProviderPaymentP12, FM36PM.ProviderPaymentP12, FM36P.ProviderPaymentP12, CASE WHEN @IncludeHEAdvLoanPossibleIncome = 1 THEN HE.GROSSFEE ELSE 0 END / 12, 0 ),
			...
			LearnDelSecondProv1618PayP12 = COALESCE ( FM36PM.LearnDelSecondProv1618PayP12, FM36P.LearnDelSecondProv1618PayP12, 0 ),
			LearnDelFirstEmp1618PayP12 = COALESCE ( FM36PM.LearnDelFirstEmp1618PayP12, FM36P.LearnDelFirstEmp1618PayP12, 0 ),
			LearnDelSecondEmp1618PayP12 = COALESCE ( FM36PM.LearnDelSecondEmp1618PayP12, FM36P.LearnDelSecondEmp1618PayP12, 0 ),
